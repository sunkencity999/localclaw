...
${formatHelpExamples([
  ...
  [
    "openclaw agents set-identity --workspace ~/.localclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "openclaw agents set-identity --identity-file ~/.localclaw/workspace/IDENTITY.md --agent main",
