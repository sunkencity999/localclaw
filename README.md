...
Full configuration reference (all keys + examples): [OpenClaw Configuration](https://docs.openclaw.ai/gateway/configuration)
...
- **[Gateway](https://docs.openclaw.ai/gateway)** — WebSocket control plane for sessions, tools, and events
- **[Multi-channel inbox](https://docs.openclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Signal, iMessage, and more
...
LocalClaw is a fork of [OpenClaw](https://github.com/openclaw/openclaw), the personal AI assistant built by Peter Steinberger and the community.
