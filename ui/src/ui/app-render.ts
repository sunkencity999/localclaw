        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src="/favicon.svg" alt="${resolveProductName()}" />
            </div>
            <div class="brand-text">
              <div class="brand-title">${resolveProductName().toUpperCase()}</div>
        ...
        ${
          state.tab === "overview"
            ? renderOverview({
                ...
                orchestrator: state.orchestratorSnapshot,
